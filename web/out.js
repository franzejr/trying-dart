...
["", "todo.dart", , N, {
  ...
  main: [function() {
    ...
    var t1 = J.get$onChange$x($.toDoInput);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(N.addToDoItem$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 1],
  addToDoItem: [function(e) {
    var newToDo = document.createElement("li", null);
    newToDo.textContent = J.get$value$x($.toDoInput);
    J.set$value$x($.toDoInput, "");
    J.get$children$x($.toDoList).add$1(0, newToDo);
  }, "call$1", "addToDoItem$closure", 2, 0, 20]
},
1],
];
setupProgram(dart);
